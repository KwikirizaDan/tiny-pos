...
-- RLS policies are now defined in supabase/rls-policies.sql (canonical source).
-- Run that file to apply all RLS policies.
-- Run supabase/fix-recursion.sql first if you previously ran this schema file
-- (it drops the old-style policies defined below).
